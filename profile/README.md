...
* Read [BIP 52](https://github.com/bitcoin/bips/blob/master/bip-0052.mediawiki) for a quick start. Note that the proposal implies reduction of the total hash rate, while keeping the total amount of computation approximately the same, rather than increasing the hash rate.
